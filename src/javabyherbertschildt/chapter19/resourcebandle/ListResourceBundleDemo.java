package javabyherbertschildt.chapter19.resourcebandle;
...
public class ListResourceBundleDemo {
    public static void main(String[] args) {
        ...
        ResourceBundle rd = ResourceBundle.getBundle("SampleResourceBundle", Locale.ENGLISH);
        ...
        rd = ResourceBundle.getBundle("SampleResourceBundle", Locale.GERMAN);
